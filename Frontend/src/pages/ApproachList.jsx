            ...
            <div className={`flex-1 flex flex-col min-w-0 transition-all duration-300 ${isSidebarOpen ? 'ml-72' : 'ml-20'}`}>
                <header className="bg-white shadow-sm z-10">
                    <div className="flex items-center gap-4 p-4">
                        <h1 className="ml-2 font-bold text-3xl text-black">Approach List</h1>
                    </div>
                </header>
                <main className="flex-1 overflow-auto p-4 md:p-6">
                    <div className="bg-white rounded-xl shadow-sm p-4 md:p-6">
                        <h3 className="text-lg font-semibold mb-4">Approach List Details</h3>
                        <p className="text-gray-600">This is the page where approach list details will be displayed.</p>
                    </div>
                </main>
            </div>
        </div>
